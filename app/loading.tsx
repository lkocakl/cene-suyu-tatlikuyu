    ...
    return (
        <div className="min-h-screen bg-[#fafaf9]">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                {/* Başlık ve açıklama iskeleti */}
                <div className="mb-12 animate-pulse">
                    <div className="h-8 w-64 bg-stone-200 rounded-md mb-4"></div>
                    <div className="h-4 w-96 bg-stone-200 rounded-md"></div>
                </div>

                {/* Yanıp sönen 8 adet iskelet kart */}
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    {[1, 2, 3, 4, 5, 6, 7, 8].map((item) => (
                        <div
                            key={item}
                            className="bg-white rounded-[2rem_8px_2rem_8px] p-4 border border-stone-100 h-80 flex flex-col justify-between shadow-xs animate-pulse"
                        >
                            <div>
